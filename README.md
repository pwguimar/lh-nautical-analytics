...
| **Sumário Executivo** | Relatório em PDF com os principais insights para a diretoria | [`sumario_executivo.pdf`]([sumario_executivo.pdf](https://github.com/pwguimar/lh-nautical-analytics/blob/main/Sumario_Executivo.pdf)) |
---
